...
$(BIN_DIR)/test_lexer.exe: $(ERROR_OBJS) $(LEXER_OBJS) $(TEST_LEXER_OBJS)
	$(CXX) $(CXXFLAGS) $(LDFLAGS) $(ERROR_OBJS) $(LEXER_OBJS) $(TEST_LEXER_OBJS) -o $@
	@echo Linked $@.

$(BIN_DIR)/test_parser.exe: $(ERROR_OBJS) $(LEXER_OBJS) $(PARSER_OBJS) $(TEST_PARSER_OBJS)
	$(CXX) $(CXXFLAGS) $(LDFLAGS) $(ERROR_OBJS) $(LEXER_OBJS) $(PARSER_OBJS) $(TEST_PARSER_OBJS) -o $@
	@echo Linked $@.

$(BIN_DIR)/test_semantic_main.exe: $(ERROR_OBJS) $(SEMANTIC_OBJS) $(AST_OBJS) $(TEST_SEMANTIC_MAIN_OBJS)
	$(CXX) $(CXXFLAGS) $(LDFLAGS) $(ERROR_OBJS) $(SEMANTIC_OBJS) $(AST_OBJS) $(TEST_SEMANTIC_MAIN_OBJS) -o $@
	@echo Linked $@.

$(BIN_DIR)/test_semantic_us11.exe: $(ERROR_OBJS) $(SEMANTIC_OBJS) $(AST_OBJS) $(TEST_SEMANTIC_US11_OBJS)
	$(CXX) $(CXXFLAGS) $(LDFLAGS) $(ERROR_OBJS) $(SEMANTIC_OBJS) $(AST_OBJS) $(TEST_SEMANTIC_US11_OBJS) -o $@
	@echo $@.

$(BIN_DIR)/test_semantic_us12.exe: $(ERROR_OBJS) $(SEMANTIC_OBJS) $(AST_OBJS) $(TEST_SEMANTIC_US12_OBJS)
	$(CXX) $(CXXFLAGS) $(LDFLAGS) $(ERROR_OBJS) $(SEMANTIC_OBJS) $(AST_OBJS) $(TEST_SEMANTIC_US12_OBJS) -o $@
	@echo Linked $@.

$(BIN_DIR)/test_semantic_us13.exe: $(ERROR_OBJS) $(SEMANTIC_OBJS) $(AST_OBJS) $(TEST_SEMANTIC_US13_OBJS)
	$(CXX) $(CXXFLAGS) $(LDFLAGS) $(ERROR_OBJS) $(SEMANTIC_OBJS) $(AST_OBJS) $(TEST_SEMANTIC_US13_OBJS) -o $@
	@echo Linked $@.

$(BIN_DIR)/test_integration.exe: $(ERROR_OBJS) $(LEXER_OBJS) $(PARSER_OBJS) $(AST_OBJS) $(SEMANTIC_OBJS) $(IR_OBJS) $(TEST_INTEGRATION_OBJS)
	$(CXX) $(CXXFLAGS) $(LDFLAGS) $(ERROR_OBJS) $(LEXER_OBJS) $(PARSER_OBJS) $(AST_OBJS) $(SEMANTIC_OBJS) $(IR_OBJS) $(TEST_INTEGRATION_OBJS) -o $@
	@echo Linked $@.
...
$(BIN_DIR)/test_output_validation.exe: $(ERROR_OBJS) $(LEXER_OBJS) $(PARSER_OBJS) $(SEMANTIC_OBJS) $(IR_OBJS) $(CODEGEN_OBJS) $(TEST_OUTPUT_VALIDATION_OBJS)
	$(CXX) $(CXXFLAGS) $(LDFLAGS) $(ERROR_OBJS) $(LEXER_OBJS) $(PARSER_OBJS) $(SEMANTIC_OBJS) $(IR_OBJS) $(CODEGEN_OBJS) $(TEST_OUTPUT_VALIDATION_OBJS) -o $@
	@echo Linked $@.
